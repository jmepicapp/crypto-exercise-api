...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public void save(TransactionDTO transaction) throws AccountNotEnoughBalanceException {
        ...
        if (accountFrom.isTreasury() || this.hasFromAccountEnoughBalance(transaction)) {
            ...
            accountTo.setBalance(accountFrom.getBalance() + transaction.getBalance());
            this.transactionRepository.save(ModelMapperUtil.map(transaction, TransactionEntity.class));
            this.accountService.save(accountFrom);
            this.accountService.save(accountTo);
        } else {
